...
__all__ = ['BNInception_trimmed', 'bninception_trimmed']
...
class BNInception_trimmed(nn.Module):

    def __init__(self, num_classes=1000):
        super(BNInception_trimmed, self).__init__()
        inplace = True
...
def bninception_trimmed(num_classes=1000, pretrained='imagenet'):
    r"""BNInception model architecture from <https://arxiv.org/pdf/1502.03167.pdf>`_ paper.
    """
    model = BNInception_trimmed(num_classes=num_classes)
